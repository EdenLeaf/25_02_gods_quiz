...
class StartGame:
    ...
    def __init__(self):
        ...
        self.play_button = Button(self.entry_area_frame, font=("Arial", "16", "bold"),
                                  bg="#E1D5E7", text="Play", width=10, command=self.check_rounds)
...
class Play:
    ...
    def new_round(self):
        ...
        while True:
            ...
            print("test")
            # If all gods have been asked about(with the player answering correctly), allow duplicates
            if 1 <= len(self.past_correct_gods) < 6:
                if correct_god[2] not in self.past_correct_gods:
                    continue
            print(correct_god[2])
            break
        ...
        if len(self.past_correct_gods) > 5:
    ...
    def round_results(self, user_choice, correct_god):
        ...
        if god_name == correct_god[2]:
            ...
            # add correctly answered god to past gods list to prevent duplicates of correctly answered questions
            self.past_correct_gods.append(correct_god[2])
            print(len(self.past_correct_gods))
        else:
