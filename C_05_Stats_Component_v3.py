...
class Stats:
    ...
    def __init__(self, partner, all_stats_info):
        ...
        buttons_strings = [
            ["Export to File", "#F0A30A", 20, lambda:self.export_to_file(export_strings)],
    ...
    def export_to_file(self, strings):
        ...
        with open(write_to, "w") as text_file:
            ...
            text_file.write(strings[0])
            text_file.write(strings[1])
            text_file.write(strings[2])
            text_file.write(strings[3])
            text_file.write("-" * 25)
