...
class Play:
    ...
    def __init__(self, how_many):
        ...
        for item in range(0, 4):
            ...
            self.god_button_ref.append(self.colour_button)
    ...
    def new_round(self):
        ...
        self.question_label.config(text=f"Who is the god of the {correct_god[3]}?", bg=god_colour)
